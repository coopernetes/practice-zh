...
| File                                  | Generated By  |
| ------------------------------------- | ------------- |
| `words_additional.json`               | `pipeline.js` |
| `unknown_chunks.tsv`                  | `pipeline.js` |
| `unknown_chunks_cedict.json`          | `pipeline.js` |
| `unknown_chunks_cedict_enriched.json` | `pipeline.js` |
| `unknown_chunks_notfound.json`        | `pipeline.js` |
| `words_additional.notfound.json`      | `pipeline.js` |

### Manual/Custom

| File                                              | Purpose                         |
| ------------------------------------------------- | ------------------------------- |
| `custom_words.json`                               | Hand-curated vocabulary         |
| `words_additional_custom.json`                    | Enriched custom words           |
| `words_additional_custom_from_unknown_nouns.json` | Manual entries for tricky nouns |
